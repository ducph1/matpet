<footer class="footer">
  <div class="grid dogs-row">
    <div class="grid wide footer-dogs">
      <div class="row">
      ...
      <div class="row">
        <div class="grid__column-4pe">
          ...
          <ul class="footer-list">
            <li>
              <a href=""><i class="footer-icon fas fa-map-marker-alt"></i><span class="footer-textbold">Địa
                  chỉ:</span> Triều Khúc
                - Thanh Xuân - Hà Nội</a>
            </li>
            <li>
              <a href=""><i class="footer-icon fas fa-map-marker-alt"></i><span class="footer-textbold">Địa
                  chỉ:</span> Quang Trung
                - Gò Vấp - thành phố Hồ Chí Minh</a>
            </li>
            <li>
              <a href=""><i class="footer-icon fas fa-phone-alt"></i><span class="footer-textbold">Điện
                  Thoại:</span>
                0386284634</a>
            </li>
            <li>
              <a href=""><i class="footer-icon far fa-envelope"></i><span class="footer-textbold">Email:</span>
                matpetfake@gmail.com</a>
            </li>
          </ul>
        </div>
        ...
        <div class="grid__column-2pe">
          ...
          <ul class="footer-list">
            <li>
              <a href=""><i class="footer-icon fab fa-facebook"></i> Facebook</a>
            </li>
            <li>
              <a href=""><i class="footer-icon fab fa-instagram"></i> Instagram</a>
            </li>
            <li>
              <a href=""><i class="footer-icon fab fa-youtube"></i> Youtube</a>
            </li>
          </ul>
        </div>
        <div class="grid__column-2pe">
  ...
  <div class="grid wide">
    <div class="footer-sub">
      <div class="footer-sub-img">
        <img src="./assets/img/mật-pet-logo-300x297.png" alt="logo" />
      </div>
      <div class="footer-sub-text">
        <div class="footer-sub-link">
          <a href="">Chính sách</a> --
          <a href="">Terms & Conditions</a> -- <a href="">Cookies</a> --
          <a href="">Blog</a> -- <a href="">Thông tin</a> --
          <a href="">Site Map</a>
        </div>
